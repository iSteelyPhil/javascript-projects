...
console.log(  `I'm enjoying learning to code in ${language.replace('JavaScript', 'JS').trim().toLowerCase()}  `);
...
//or
console.log(`T${notTitleCase.slice(1,5)} C${notTitleCase.slice(7,11)}`);
