...
console.log(
  `${
    bear.name
  } earned an average test score of ${bear.avgScore()}% and has a status of ${bear.status()}.`
);
console.log(
  `${
    merry.name
  } earned an average test score of ${merry.avgScore()}% and has a status of ${merry.status()}.`
);
console.log(
  `${
    gator.name
  } earned an average test score of ${gator.avgScore()}% and has a status of ${gator.status()}.`
);
...
console.log(
  `It took ${
    gator.name
  } ${gatorLoop()} tests to finally reach ${gator.status()}!`
);
console.log(
  `${
    gator.name
